...
OBJS = obj/util.o obj/platform.o obj/api.o obj/cache.pb.o obj/cache.o
NDEBUG = -D NDEBUG
DEBUG_SYM = -g -O0
...
# object files
obj/plsync.o: src/plsync.cpp include/platform.h include/util.h include/api.h include/cache.pb.h include/cache.h
...
obj/api.o: src/api.cpp include/api.h include/cache.h include/platform.h include/util.h include/client_secret.h
	clang++ -o obj/api.o -c $(CXX) src/api.cpp $(DEBUG_OR_PROD)

obj/cache.o: include/cache.h src/cache.cpp include/util.h include/cache.pb.h include/api.h
